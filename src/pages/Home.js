...
import { Twitter, Instagram, Facebook, Envelope } from "react-bootstrap-icons";
...
function PageContainer(props) {
  ...
  return (
    <section className="scroll-container p-0 border border-white">
...
const Throwball = ({ ox, oy, spinTime }) => {
  return (
        ...
        <section className="scroll-container p-0">
          <div className="page-container">
            <div className="content-container">
              <Throwball
                ox={ballAnimationSettings.vertical.originX}
                oy={ballAnimationSettings.vertical.originY}
                spinTime={ballAnimationSettings.duration}
              />
            </div>
            <div className="banner-row">
              <div className="banner-container">
                <motion.div
                  initial={{ scale: 0, opacity: 0, skew: -20 }}
            ...
            <div className="content-container">
              <div className="d-block fs-1">
                ...
                <Row className="mb-3">
                  <Col></Col>
                  <Col>
                    <a href="https://www.maxpreps.com/tx/san-antonio/antonian-prep-apaches/athletes/madison-olguin/?careerid=flf7tv0sp6144">
                      MaXPreps
                    </a>
                  </Col>
                  <Col></Col>
